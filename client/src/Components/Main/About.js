  ...
  return (
    <div className='px-44'>
      ...
      <p className='text-right text-5xl'>
        <br />
        <a target="_blank" href="https://github.com/ujjwalSk/" className='hover:drop-shadow-md hover:text-purple'><i className="fa-brands fa-github"></i></a>&nbsp;&nbsp;&nbsp;
        <a target="_blank" href="https://www.linkedin.com/in/ujjwalsk/" className='hover:drop-shadow-md hover:text-metal'><i className="fa-brands fa-linkedin"></i> </a>&nbsp;&nbsp;
      </p>
    </div>
  )
}
