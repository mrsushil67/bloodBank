...
const UserForm = () => {
    ...
    }, [me, user.name, user.bloodGroup, user.age, user.gender, bloodGroups]);
                    ...
                    <table className="w-full" cellPadding={10}>
                        ...
                        <tr>
                            {handle === "request" && <><td>
                                ...
                                />
                            </td><td><label htmlFor="gender" className="font-semibold  leading-8">Gender:<font color="red">*</font></label>
                        ...
                        <tr>
                            <td><label htmlFor="state" className="font-semibold  leading-8">State:<font color="red">*</font></label>
                            ...
                            <td><label htmlFor="district" className="font-semibold  leading-8">District:<font color="red">*</font></label>
